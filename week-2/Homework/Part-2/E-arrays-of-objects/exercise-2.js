...
.find(transporte => transporte.transportations
    .some((trans)=> trans == "ferry")).destinationName; // Complete here
...
.map(destino => destino.destinationName)// Complete here (PRINT THE RESULT IN THE CONSOLE USING FOREACH)
